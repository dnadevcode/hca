function [ xcorrs, numElts ] = masked_multidim_pcc_corr( shortVec,longVec,w1,w2, minLen )
    % masked_pcc_corr
    ...
    numElts = zeros(longLength,size(shortVec,2),2);
    xcorrs = zeros(longLength,size(shortVec,2),2);
    ...
    xcorrs(:,:,1) = xiyi./denominator - numForward.*xbar.*ybar./denominator;
    ...
    xcorrs(:,:,2)  = xiyi./denominator - numForward.*xbar.*ybar./denominator;
