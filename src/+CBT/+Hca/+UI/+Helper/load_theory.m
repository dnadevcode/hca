function [ theoryStruct ] = load_theory( sets )
    ...
    for idx=1:length(sets.theoryFile)
        ...
        if isequal(st,'.txt')
            ...
            % all theories
           try
           [bars, bits, names, meanbpnm, pixelWidth_nm, psfSigmaWidth_nm, isLinearTF,marks] = ...
           ...
           [bars, bits, names, meanbpnm, pixelWidth_nm, psfSigmaWidth_nm, isLinearTF] = ...
            ...
            if ~sets.theory.theoryDontSaveTxts
                ...
                bits;...
                marks; arrayfun(@(x) isLinearTF,1:length(bars),'un',false);...
                names;...
                ...
                {'rawBarcode','rawBitmask', 'rawMarks','isLinearTF','name','length','meanBpExt_nm','pixelWidth_nm','psfSigmaWidth_nm'},2);
                catch
                theoryStruct = cell2struct([bars;...
